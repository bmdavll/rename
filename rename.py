    ...
    try:
        ...
        parser.add_option("-e", "--expression", metavar="EXPR",
                          ...
                          help='one or more semicolon-separated transformations '
                               ...
                               'insensitive pattern), "g" (replace all occurrences), '
                               'and N > 0 (replace up to N occurrences); available '
                               'flags for y/// are the same as in Perl: "c" '
                               '(complement the search list), "d" (delete found but '
                               'unreplaced characters), and "s" (squash duplicate '
                               'replaced characters). '
